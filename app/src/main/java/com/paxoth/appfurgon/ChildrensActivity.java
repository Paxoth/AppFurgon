...
public class ChildrensActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Ninos ninos_data[] = new Ninos[]{
                new Ninos(R.drawable.user,"Niño1",new LatLng(-33.420215, -70.735511),estados.get(0),lista_apoderado[0]),
                new Ninos(R.drawable.nina,"Niño2",new LatLng(-33.422955, -70.738505),estados.get(1),lista_apoderado[1]),
                new Ninos(R.drawable.user,"Niño3",new LatLng(-33.425498, -70.727776),estados.get(2),lista_apoderado[2]),
                new Ninos(R.drawable.user,"Niño4",new LatLng(-33.425086, -70.721081),estados.get(3),lista_apoderado[3]),
                new Ninos(R.drawable.nina,"Niño5",new LatLng(-33.422794, -70.718881),estados.get(4),lista_apoderado[4]),
                new Ninos(R.drawable.user,"Niño6",new LatLng(-33.419248, -70.716650),estados.get(5),lista_apoderado[5]),
                new Ninos(R.drawable.nina,"Niño7",new LatLng(-33.419821, -70.714043),estados.get(6),lista_apoderado[6]),
                new Ninos(R.drawable.user,"Niño8",new LatLng(-33.421621, -70.712305),estados.get(7),lista_apoderado[7]),
                new Ninos(R.drawable.nina,"Niño9",new LatLng(-33.419750, -70.712315),estados.get(8),lista_apoderado[8]),
                new Ninos(R.drawable.nina,"Niño10",new LatLng(-33.413696, -70.710095),estados.get(9),lista_apoderado[9]),
                new Ninos(R.drawable.user,"Niño11",new LatLng(-33.414359, -70.704097),estados.get(10),lista_apoderado[10]),
                new Ninos(R.drawable.nina,"Niño12",new LatLng(-33.418227, -70.707477),estados.get(11),lista_apoderado[11]),
                new Ninos(R.drawable.user,"Niño13",new LatLng(-33.419687, -70.708882),estados.get(12),lista_apoderado[12]),
                new Ninos(R.drawable.nina,"Niño14",new LatLng(-33.421621, -70.712251),estados.get(13),lista_apoderado[13]),
                new Ninos(R.drawable.user,"Niño15",new LatLng(-33.423233, -70.713785),estados.get(14),lista_apoderado[14]),
                new Ninos(R.drawable.nina,"Niño16",new LatLng(-33.424191, -70.707294),estados.get(15),lista_apoderado[15]),
                new Ninos(R.drawable.nina,"Niño17",new LatLng(-33.425821, -70.705395),estados.get(16),lista_apoderado[16]),
                new Ninos(R.drawable.user,"Niño18",new LatLng(-33.427629, -70.706865),estados.get(17),lista_apoderado[17]),
                new Ninos(R.drawable.nina,"Niño19",new LatLng(-33.428623, -70.703046),estados.get(18),lista_apoderado[18]),
                new Ninos(R.drawable.nina,"Niño20",new LatLng(-33.425901, -70.700127),estados.get(19),lista_apoderado[19]),
